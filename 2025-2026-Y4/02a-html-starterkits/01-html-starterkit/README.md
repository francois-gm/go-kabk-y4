# Starting right (with a HTML starterkit)
...
For the **HTML** starterkit, here are the following components:
...
The CSS starter file (`style.css`)includes several elements.
